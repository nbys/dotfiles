...
M.on_attach = function(client, bufnr)
	...
	mapkey("<leader>y", "Lspsaga show_line_diagnostics", "n", opts) -- show  diagnostics for line
	mapkey("<leader>t", "Lspsaga show_cursor_diagnostics", "n", opts) -- show diagnostics for cursor
